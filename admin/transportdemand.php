...
<div class="col-md-12">
    <div class="col-md-6 p-l-0">
        <h2 class="top">Transport Demand - Export</h2>
    </div>
        <form  id="otherfeefilters" class="form-inline" method="post" action="transportdemanddata.php">
            ...
            <div class="form-group">
                <button type="submit" name="tfdemandexportexcel" id="tfdemandexportexcel" value="demand" class="btn btn-info">Export Transport Demand</button>
            </div>
            </div>
        </form>
