<?php
	...
	$query = "SELECT * FROM nonfeeconfigdata WHERE id='$id'"; 
			...
			<div class="content content1">
				...
				<div class="main">
					<form id="user_registered" method="post" action="adminactions.php">
						...
						<input name="academic" type="hidden" value="<?php echo $res['acdemic_yr_id'];?>" />
								...
								<select name="semester" class="form-control" >									
									<?php
										...
										foreach ($termData as $value) {
											if (trim($res['semester']) == trim($value['semester']))								
						...
						<div class="form-group">
							...
							<select name="feeType" class="form-control" >									
									<?php
										$feeData = sqlgetresult("SELECT * FROM tbl_nonfee_type");
						...
						<div class="form-group text-center">
							<button type="submit" value="update" name="editnonfeeconfig" class="btn btn-primary text-center">Update</button>
							<a href="nonfeeconfig.php"><button type="button" value="Go Back" class="btn btn-warning text-center">Back</button></a>
					    </div>
