	...
	<div class="row">
		...
		<div class="col-sm-8 col-md-6 col-lg-4">
			<div class="content content1">
				<p class="heading">Add Waiver Type</p>
				<div class="main">
					<input name="id" type="hidden" value="<?php echo $res['id'];?>" />
					<form id="user_registered" method="post" action="adminactions.php">
						<div class="form-group">
								<label for ="name" class="control-label">Waiver Type</label>
								<input type="text" id="waivertype" name="waivertype" required placeholder="Waiver Name" class="form-control">
						</div>
						<div class="form-group">
						...
						<div class="form-group text-center">
							<button type="submit" value="new" name="addWaivertype" class="btn btn-primary text-center">Add</button>
