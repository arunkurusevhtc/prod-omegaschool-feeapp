...
<div class="container-fluid">
    <div class="col-lg-12">
            <h2 class="top">Advance Payment - Balance REPORT</h2>
    </div>
<!--    <div class="col-lg-12 challanthereornot">
    ...
    <form  id="filteradvancereport" class="form-inline">
            ...
            <div class="form-group">
            <button type="button" id="fltadvBalRpt" name="filter" value="fltadvBalRpt" class="btn btn-info">Filter</button>
           </div>
           <?php if($roleid == 1) { ?>
            <div class="form-group">
                <a href="" class="btn btn-info advbalexportexcel">Export Excel</a>
