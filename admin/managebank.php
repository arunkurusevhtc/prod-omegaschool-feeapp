...
<div>
   ...
   <h2 class="top">Manage Bank</h2>
</div>
      <div class="container-fluid col-md-12">
         <div class="table-responsive">
            <table class="table table-bordered admintab dataTableBank">
            <!-- <caption class="title">Sales Data of Electronic Division</caption> -->
               ...
               <tbody>
                  <?php
                  $count=1;
                  $sql = 'SELECT * FROM adminbankcheck';
                  ...
                  ?>
                     <tr>
                        ...
                        <td><?php echo trim($clas["bank"]); ?></td>
                        <td><?php echo trim($clas["description"]); ?></td>
                        <td><?php echo trim($clas["status"]); ?></td>
                        <td class="fafa">
                           <?php if($clas["status"] =="ACTIVE"){?>
                           <a href="adminactions.php?status=ACTIVE&id=<?php echo $clas["id"];?>&page=bank"><i class="fa fa-check fafaactive"></i></a>
                           <?php }else{?>
                           <a href="adminactions.php?status=INACTIVE&id=<?php echo
                           $clas["id"];?>&page=bank"><i class="fa fa-close fafainactive"></i></a>
                           <?php } ?>
                           <a href="editbank.php?id=<?php echo $clas["id"]; ?>"><i class="fa fa-edit"></i></a> 
                           <a href="adminactions.php?action=delete&id=<?php echo $clas["id"]; ?>&page=bank"><i class="fa fa-trash-o"></i></a>
                        </td>
                     </tr>
                     <?php $count++;
                     } 
