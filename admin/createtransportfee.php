                  ...
                  <input name="semester" id="semester" type="hidden" value="<?php echo $st_sem;?>">
                    ...
                    <div id='demandData' class="feetab1 edittech">
                        ...
                        <div class="form-group text-center"> 
                            <input type="hidden" name="showtransfeechallan" value="showtransfeechallan" >                         
                            <button type="submit" name="showtransfeechallan" value="showtransfeechallan" class="btn btn-primary text-center" id="showtransfeechallan">Create Fee Challan</button>
