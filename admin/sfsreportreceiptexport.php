...
<div class="container-fluid">
	<div class="col-lg-12">
			<h2 class="top">SFS Receipt Report</h2>
	</div>
	    	...
	    	<div class="col-lg-12 text-right">
	            ...
	            <div class="form-group">
					<div>
						...
						<option value="RECEIPT" selected>Receipt Report</option>
						</select>
					</div>
				</div> 
				<div class="form-group">
	   	    ...
	   	    <!-- <div class="text-right"> -->
				<div class="form-group">
					<button type="submit" name="excel" value="sfsreceiptreportexport" class="btn btn-info">Export Excel</button>
				</div>
			</div>
		</form>
	</div>