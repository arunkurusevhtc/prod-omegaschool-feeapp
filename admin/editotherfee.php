...
if(!empty($pid)){
   ...
   // $sql = 'SELECT  * FROM tbl_payments WHERE id = \'' . $pid . '\'';
    ...
    //exit;
      foreach($query as $key => $q){
            ...
            $transStatus=trim($q['transStatus']);
            $transNum=trim($q['transNum']);
            $transId=trim($q['transId']);
            $remarks=trim($q['remarks']);
            $transDate=trim($q['transDate']);
            $returnCode=trim($q['returnCode']);
...
<div class="container_fluid">
        ...
        <div class="col-sm-8 col-md-6 col-lg-6">
            ...
            <div class="contentcheque">
                <p class="heading">Edit Payment</p>
                <div class="main">
                        <?php if(!empty($sid)) { ?>
                        <form method="post" id="studDataModal1" action="adminactions.php">
                            ...
                            <div class="col-lg-12 well">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <textarea placeholder="Remarks" class="form-control remarks" name="remarks" maxlength="250"><?php echo $remarks; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                <div class="col-lg-6">
                            ...
                            <div class="text-center">
                                <button type="button" id="closepay_ftype" class="btn btn-default" name='close' value="confirm" onclick="window.location.href='manageotherfees.php'">Close</button>
                                <button type="submit" name='edit_fee_other_pay' value="confirm" class="btn btn-primary" >Submit</button>
                            </div>
                        </form>
                    <?php } ?>
                    </div>
