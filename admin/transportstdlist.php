<?php
	...
	if (isset($_SESSION['selectedtransfeechallans'])) {
		unset($_SESSION['selectedtransfeechallans']);
	}
	$studData = array();
...
<div class="container-fluid">
  <div class="row col-md-12">
	...
	<div class="col-md-12"> 
		<h2 class="top text-right">TRANSPORT FEE CHALLAN CREATION</h2>
	</div>
	<div class="col-md-12">
		<p style="color:red;font-size:11px;">Please use below filters to create transport fee challans.</p>
	</div>
	<div class="row col-md-12">
		<form action="adminactions.php" method="post" >
			<div class="col-md-2">
				<div class="form-group addsub">
					<select class="form-control" name="typeforfee" id="typeforfee">
	...
	<div class="col-md-12" >
		<form  method="post" action="adminactions.php">
					...
					<tbody>
						<?php
							...
							if($num > 0)
							{
								...
								<td class="fafa">
								<a href="createtransportfee.php?id=<?php echo trim($data["studentId"]); ?>"><i class="fa fa-edit"></i></a>
								</td>
			...
			<button type = "submit" name="submit" id="clickme" value="createtransportchallan" class = "btn btn-info sendnewsms"  disabled="disabled">Edit Students</button>
		</form>
	</div>  
</div>
...
<script type="text/javascript">
	...
	var btnhtml = '<div class="col-md-1 subtn"><button type="submit" name="feetransfilter" value="feetransfilter" id="feetransfilter" class="btn btn-info nonfeetypechallan">Filter</button></div>';

    $(document).on("change", "#typeforfee", function() {
        var typename = $("#typeforfee").val();
