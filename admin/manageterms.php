            ...
            <tbody>
               ...
               ?>
                  <tr>
                     ...
                     <td><?php echo trim($fee["semester"]); ?></td>
                     <td><?php echo trim($fee["status"]); ?></td>
                     <td class="fafa">
                        <?php if($fee["status"] =="ACTIVE"){?>
                        <a href="adminactions.php?status=ACTIVE&id=<?php echo $fee["id"];?>&page=semester"><i class="fa fa-check fafaactive"></i></a>
                        <?php }else{?>
                        <a href="adminactions.php?status=INACTIVE&id=<?php echo
                        $fee["id"];?>&page=semester"><i class="fa fa-close fafainactive"></i></a>
                        <?php } ?>
                     </td>
                  </tr>
                  <?php $count++;
