<?php
	...
	if (isset($_SESSION['selectedfeechallans'])) {
...
<div class="container-fluid">
  <div class="row col-md-12">
	...
	<div class="col-md-12"> 
		<h2 class="top text-right">FEE CHALLAN CREATION</h2>
	</div>
	<div class="col-md-12">
		<p style="color:red;font-size:11px;">Please use below filters to create fee challans.</p>
	</div>
	<div class="row col-md-12">
	...
	<div class="col-md-12" >
		<form  method="post" action="adminactions.php">
					...
					<tbody>
						<?php
							...
							if($num > 0)
							{
								...
								<td class="fafa">
								<a href="feechallancreation.php?id=<?php echo trim($data["studentId"]); ?>"><i class="fa fa-edit"></i></a>
								</td>
			...
			<button type = "submit" name="submit" id="clickme" value="createfeechallan" class = "btn btn-info sendnewsms"  disabled="disabled">Edit Students</button>
		</form>
	</div>  
</div>
...
<script type="text/javascript">
	...
	var btnhtml = '<div class="col-md-1 subtn"><button type="submit" name="feetypefilter" value="feetypefilter" id="feetypefilter" class="btn btn-info nonfeetypechallan">Filter</button></div>';
