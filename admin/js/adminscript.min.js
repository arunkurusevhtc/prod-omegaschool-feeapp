$(document).ready(function () {
    ...
    $("#commfee").on("change", function () {
        if($('#commfee').is(":checked")){
            $(".productdetails").show();
        }   
        else{
            $(".productdetails").hide();
    ...
    $("#ispartial").on("change", function () {
        if($('#ispartial').is(":checked")){
            $(".duedetails").show();
            $("#feetype").attr('required', !0);
            $("#duedate").attr('required', !0);
        }   
        else{
            $("#feetype").attr('required', !1);
            $("#duedate").attr('required', !1);
            $(".duedetails").hide();
        }
    });
    $("#nonfeestudid").on("change", function () {
        ...
        if (stdid.length != 0) {
            $.ajax({
                ...
                method: "post",
                dataType: "json",
                data: { submit: "geteventnames", data: stdid },
                success: function (response) {
                    if (response == 0) {
                        ...
                        $(".eventdetails").hide();
                        $("#paycommonnonfee").attr("disabled", !0);
                    }else if (response == 2) {
                        $(".error_stdid").show();
                        $(".error_stdid").html("<p class='error-msg'>Please pay school fees before attempting this payment.</p>");
                        $amount = 0;
                        $("#amountofevent").val($amount);
                        $("option:selected", ".eventname").remove();
                        $(".eventdetails").hide();
                        ...
                        $("#paycommonnonfee").attr("disabled", !1);
                    }
                },
            });
        } else {
    ...
    $("#eventnameid").on("change", function () {
        ...
        if (stdid.length != 0) {
            $.ajax({
                ...
                method: "post",
                dataType: "json",
                data: { submit: "geteventamount", eventid: eventid, stdid: stdid },
                success: function (response) {
                    console.log(response);
                    if (response != null){
    ...
    if ($(".feeappdash").length > 0) {
        $(".datepicker").datepicker({ dateFormat: "yy-mm-dd" });
    }
    if ($(".dataTableUserPartial").length > 0) {
        getPartialPaidData();
    }
    if ($('.tfchequerevoke').length > 0) {
       document.getElementById("chequerevoketranssubmit").disabled = !0;
    }
    if ($(".passchk").length > 0) {
    ...
    $(".sfsreportexcel").attr("disabled", !0);
    $(document).on('click', '#sfsreportid', function() {
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    //var sectionselect = $("#sectionselect").val();
    var yearselect = $("#yearselect").val();
    var semesterselect = $("#semesterselect").val();
    var stid = $("#stid").val();
    ...
    $.ajax({
        ...
        success: function(response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $('.dataTableSfs').DataTable();
            if (response != null) {
                myTable.clear();
                var i = 1;
                var result = response.map(function(item) {
                    ...
                    result.push(item.paid_date);
                    result.push(item.status);
                    result.push(item.paid_status);
                    i++;
                    result.push("");
                    return result
                });
                ...
                myTable.draw();
                $(".sfsreportexcel").attr("disabled", !1);
            } else {
                $(".sfsreportexcel").attr("disabled", !0);
...
$(document).on('click', '.sfsreportexcel', function(event) {
    if (!$('.sfsreportexcel').is('[disabled=disabled]')) {
        $(".sfsreportexcel").attr("href", "adminactions.php?sfsreportexcel=exportexcel")
    } else {
        event.preventDefault();
        $(".sfsreportexcel").attr("href", "");
    }
});
/* Paid Non fee challans */
$(".exportnonexcel").attr("disabled", !0);
$(".paidnonfeereportexcel").attr("disabled", !0);
$(".commonfeereportexcel").attr("disabled", !0);
$(document).on('click', '#commonfeerpt', function() {
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    //var sectionselect = $("#sectionselect").val();
    var yearselect = $("#yearselect").val();
    ...
    if($('.quizsetid').val().length>0){
        $('.selected_quizsetids').val($('.quizsetid').val().join(','));
    }else{
        $('.selected_quizsetids').val("");
    }

    var selected_feetypes = $("#selected_feetypes").val();
    var from = $("#from").val();
    var to = $("#to").val();
    $(".pageloader").show();
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response != null) {
                ...
                myTable.rows.add(result);
                myTable.draw();
                $(".commonfeereportexcel").attr("disabled", !1);
            } else {
                $(".commonfeereportexcel").attr("disabled", !0);
                myTable.context[0].oLanguage.sEmptyTable = "No matching records found...";
                myTable.clear().draw();
...
$(document).on('click', '.commonfeereportexcel', function(event) {
    if (!$('.commonfeereportexcel').is('[disabled=disabled]')) {
        $(".commonfeereportexcel").attr("href", "adminactions.php?commonfeereportexcel=exportexcel")
    } else {
        event.preventDefault();
        $(".commonfeereportexcel").attr("href", "");
    }
});

/* Demand Non fee challans */
$(document).on('click', '#fltcreatenonfeechallan', function() {
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    var yearselect = $("#yearselect").val();
    var semesterselect = $("#semesterselect").val();
    ...
    var from = $("#from").val();
    var to = $("#to").val();
    var chlantype = $("#chlantype").val();
    var challanstatus = $("#challanstatus").val();
    $(".pageloader").show();
    $.ajax({
        type: 'post',
        url: 'adminactions.php',
        ...
        success: function(response) {
            ...
            if (response != null) {
                ...
                var result = response.map(function(item) {
                    ...
                    result.push(item.feename);
                    result.push(item.amount);
                    result.push(item.cdate);
                    result.push(item.ddate);
                    result.push(item.pdfhtml);
                    i++;
                    result.push("");
                    return result
                ...
                myTable.rows.add(result);
                myTable.draw();
                $(".exportnonexcel").attr("disabled", !1);
            } else {
                $(".exportnonexcel").attr("disabled", !0);
                myTable.context[0].oLanguage.sEmptyTable = "No matching records found...";
                myTable.clear().draw();
...
$(document).on('click', '.exportnonexcel', function(event) {
    if (!$('.exportnonexcel').is('[disabled=disabled]')) {
        $(".exportnonexcel").attr("href", "adminactions.php?nonfeechallandata=exportexcel")
    } else {
        event.preventDefault();
        $(".exportnonexcel").attr("href", "");
    }
});

/* Paid Non fee challans */
$(document).on('click', '#paidnonfeerpt', function() {
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    //var sectionselect = $("#sectionselect").val();
    var yearselect = $("#yearselect").val();
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response != null) {
                ...
                myTable.rows.add(result);
                myTable.draw();
                $(".paidnonfeereportexcel").attr("disabled", !1);
            } else {
                $(".paidnonfeereportexcel").attr("disabled", !0);
                myTable.context[0].oLanguage.sEmptyTable = "No matching records found...";
                myTable.clear().draw();
...
$(document).on('click', '.paidnonfeereportexcel', function(event) {
    if (!$('.paidnonfeereportexcel').is('[disabled=disabled]')) {
        $(".paidnonfeereportexcel").attr("href", "adminactions.php?paidnonfeereportexcel=exportexcel")
    } else {
        event.preventDefault();
        $(".paidnonfeereportexcel").attr("href", "");
    }
});
    ...
    if ($(".dataTableStudent").length > 0) {
        $("#DataTables_Table_0_filter").append('<a href="addstd.php"><button type="button" class="btn btn-info">Add Student</button></a>');
    }
    ...
    if ($(".dataTableWaiverType").length > 0) {
        $("#DataTables_Table_0_filter").append('<a href="addwaivertypes.php"><button class="btn btn-info">Add Waiver Type</button></a>')
    }
    if ($(".dataTableAdminRoles").length > 0) {
        $("#DataTables_Table_0_filter").append('<a href="addrole.php"><button class="btn btn-info">Add Admin Role</button></a>')
    }
    if ($(".dataTableAdminMenus").length > 0) {
        $("#DataTables_Table_0_filter").append('<a href="addmenu.php"><button class="btn btn-info">Add Menu</button></a>')
    }
    if ($(".dataTableBank").length > 0) {
        $("#DataTables_Table_0_filter").append('<a href="addbank.php"><button class="btn btn-info">Add Bank</button></a>')
    }
    if ($(".dataTablePartial").length > 0) {
        $("#DataTables_Table_0_filter").append('<a href="managestd.php"><button type="button" class="btn btn-info">Create New</button></a>')
    }
    ...
    if ($("#drp").length > 0) {
        $("#drp").daterangepicker({ datepickerOptions: { numberOfMonths: 2, dateFormat: "dd-mmm-yyyy" } });
    }
    if ($(".pagetax").length > 0) {
        $(".datepicker").datepicker({ dateFormat: "yy-mm-dd" });
    }
    ...
    $(document).on("change", "#grouptype", function () {
        ...
        $.ajax({
            ...
            method: "post",
            dataType: "json",
            data: { submit: "getgroupamount", gt: selectedtype, cno: cno, rid: rid },
            success: function (response) {
                console.log(response);
                $("#groupamount").show();
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.challanData == "Challan Already Exists") {
                    ...
                    html +=
                        '<form id="studDataModal"></form><input type="hidden" name="challanId" id="challanId" value="' +
                        response.challanData.id +
                        '" ><input type="hidden" name="class" value="' +
                        clasid +
                        '" /><table class="table table-striped"><tr><td colspan="2"><label> School Name: </label> LMOIS - ' +
                        response.challanData.streamname +
                        "</td></tr><tr><td><label>Name: </label> " +
                        name +
                        "</td><td><label>Semester: </label> " +
                        semester +
                        "</td></tr><tr><td><label>ID: </label> " +
                        studId +
    ...
    $(document).on("click", ".feewavier", function () {
        var id = this.id;
        if(id=="clickme"){
            id=$('.checkme:checked').map(function() { return this.value; }).get().join(',');
        }
        $(".id").val(id);
        $(".pageloader").show();
        $.ajax({
            ...
            method: "post",
            dataType: "json",
            data: { submit: "getwavierchallanno", data: id },
            success: function (response) {
                $(".pageloader").hide();
                console.log(response);
                $(".selectwavier").html("");
    ...
    $(".strchange").on("change", function () {
        ...
        $.ajax({
            ...
            method: "post",
            dataType: "json",
            data: { submit: "getClassData", data: strId },
            success: function (response) {
                var options = "";
    ...
    $(".streamchangeforstud").on("change", function () {
        ...
        if (strId.length != 0) {
            $.ajax({
                ...
                method: "post",
                dataType: "json",
                data: { submit: "getClassDataForStd", data: strId },
                success: function (response) {
                    console.log(response);
                    var options = '<option value="">Class</option>';
                    $.each(response, function (i, val) {
    ...
    $('.blkupdt').on('click', function() {
        $(".streamblk").prop('required',false);
        $(".classblk").prop('required',false);
        $(".sectionblk").prop('required',false);
        $("#changestatus").prop('required',false);
        $("#semesterselect").prop('required',false);
        $("#yearselect").prop('required',false);
    });

    $('#std_status_change').on('click', function() {
        $("#changestatus").prop('required',true);
    });

    $('#change_ay').on('click', function() {
    ...
    $('#change_stream_class').on('click', function() {
        $(".streamblk").prop('required',true);
        $(".classblk").prop('required',true);
        $(".sectionblk").prop('required',true);
    });
    $(".classchange").on("change", function () {
        ...
        if (strId.length != 0) {
            $.ajax({
                ...
                method: "post",
                dataType: "json",
                data: { submit: "getSectionData", strId: strId, classId: classId },
                success: function (response) {
                    console.log(response[0]);
                    var options = '<option value="">Section</option>';
                    if (response == null || $.trim(response[0].section) == "") {
                        options +=
                            '<option value="A">A</option><option value="B">B</option><option value="C">C</option><option value="D">D</option><option value="E">E</option><option value="F">F</option><option value="G">G</option><option value="H">H</option><option value="I">I</option><option value="J">J</option><option value="NEW">NEW</option>';
                    } else {
                        $.each(response, function (i, val) {
    ...
    $(".classcoclass").on("change", function () {
        ...
        if (strId.length != 0) {
            $.ajax({
                ...
                method: "post",
                dataType: "json",
                data: { submit: "getClassCoSectionData", strId: strId, classId: classId },
                success: function (response) {
                    console.log(response);
                    var options = '<option value="">Section</option>';
                    $.each(response, function (i, val) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response == 1) {
                    ...
                    window.location.href = 'addfeechallan.php'
                } else {
    ...
    $(document).on("click", ".viewmodal", function () {
        ...
        $.ajax({
            ...
            method: "post",
            dataType: "json",
            data: { submit: "viewChallanData", studId: studId, cid: id, feegroup: feegroup },
            success: function (response) {
                console.log(response);
                $("#challanData").html("");
                var html =
                    ...
                    response.clid +
                    '"><input class="grand_tot" type="hidden" name="grand_tot"/><input type="hidden" name="challanNo" id="challanNo" value="' +
                    response.challanNo +
                    '"><input type="hidden" name="stream"  value="' +
                    response.stream +
                    '"/><input type="hidden" name="sfsextrautilities" id="sfsutilitiesinput" /><input type="hidden" name="schoolextrautilities" id="schoolutilitiesinput" /><input type="hidden" name="sfsextrautilitiesamount" id="sfsutilitiesinputamount"/><input type="hidden" name="schoolextrautilitiesamount" id="schoolutilitiesinputamount"/><input type="hidden" name="sfsextrautilitiesqty" id="sfsutilitiesinputqty"/><input type="hidden" name="schoolextrautilitiesqty" id="schoolutilitiesinputqty"/><table class="table table-striped"><tr><td colspan="2"><label> School Name: </label> LMOIS - ' +
                    response.steamname +
                    "</td></tr><tr><td><label>Name: </label> " +
                ...
                $.each(response.feeData, function (i, row) {
                    ...
                    amount -= wpamt;
                    html +=
                        '<tr class="innerborder2"><td colspan="2"><input type="hidden" id="grouptotal" name="grouptotal" value="' + pamt + '" /><strong>Total: </strong></td><td><span id="grouptot">' + (pamt - wpamt) + "</span></td></tr>";
            ...
            success: function (data) {
                ...
                if (data.selecteddata == null) {
                    ...
                    if (typeof response[0].feename != "undefined" && response[0].feename !== null) {
                        html +=
                            "<table class='sfstbl' width='600'><tr><th width='30' class='text-center'>S.No</th><th width='250' class='text-center'>Particulars</th><th width='80' class='text-center'>Quantity</th><th class='text-center' width='120' >Amount</th><th>Action</th></tr>";
                        for (var i = 0; i < response.length; i++) {
                            html +=
                                '<tr class=""><td class="text-center m-t-15">' +
                                (i + 1) +
                                '</td><td class="text-center"><label class="control-label">' +
                                response[i].feename +
                                '</td><td class="text-center">' +
                                response[i].quantity +
                                '</td><td class="text-right">' +
                                response[i].total +
                                '</div></td><td><a href="adminactions.php?remove=sfs&sid=' +
                                response[i].sfsid +
                                "&cid=" +
                                response[i].cid +
                                '">Remove</a></td></tr>';
                    ...
                    html +=
                        '</select></td><td><select id = "sfsextraqty" class="form-control"><option value="">--SELECT--</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select></td></tr>';
    ...
    $(document).on("change", "#sfsutilites", function () {
        ...
        if (selectedtype.toLowerCase().indexOf(str1.toLowerCase()) != -1) {
            ...
            $.ajax({
                url: "adminactions.php",
                type: "POST",
                data: { submit: "getOtherFeeData", id: selected, data: data, feegroup: "SFS", qty: sfsqty },
                dataType: "json",
                success: function (response) {
                    console.log(response);
                    if (response != null) {
                        var finalamount = response.amount * sfsqty;
                        var tormve = $("table#sfsutilitestbl tr." + selected)
                            .find("td:eq(1)")
                            .text();
                        if (tormve != "") {
                        ...
                        var html =
                            ...
                            "</td><td>" +
                            finalamount +
                            '</td><td><i title="remove" class="fa fa-close" onclick="rmveSfsUtility(' +
                            finalamount +
                            "," +
                            response.id +
                            "," +
    ...
    $(".paidexportexcel").attr("disabled", !0);
    $(".nfwcpaidexportexcel").attr("disabled", !0);
    $(".advanceexportexcel").attr("disabled", !0);
    $(".advbalexportexcel").attr("disabled", !0);
    $(".consolidatedexportexcel").attr("disabled", !0);
    $(".ledgerreportcoloumnwiseexportexcel").attr("disabled", !0);
    $(".otherexportexcel").attr("disabled", !0);

    $(".partialexportexcel").attr("disabled", !0);
...
function getComments() {
    $.ajax({ type: "post", url: "adminactions.php", dataType: "json", data: { submit: "getComments" }, success: function (response) {} });
}
...
$("#payment_details").submit(function (e) {
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "feeentry", classselect: classselect, streamselect: streamselect, sectionselect: sectionselect },
        success: function (response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $(".payreport").DataTable();
...
$(document).on("click", "#fltfrm", function () {    
   // event.preventDefault();
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    var sectionselect = $("#sectionselect").val();
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filterbut", classselect: classselect, streamselect: streamselect, sectionselect: sectionselect, semesterselect: semesterselect, yearselect: yearselect },
        success: function (response) {
            $(".pageloader").hide();
            ...
            if (response != null) {
                ...
                var result = response.map(function (item) {
                    var result = [];
                    result.push('<input type="checkbox" name="checkme[]" class="checkme" value="' + item.challanNo + '" style="margin:10px;" id="checkme' + i + '"><input type="hidden" name="cid[]"  value="' + item.challanNo + '">');
                    result.push(i);
                    result.push(item.studentId);
                    result.push(item.studentName);
...
$("#feeconfigdetails").submit(function (e) {
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filterfeeconfiguration", classselect: classselect, streamselect: streamselect },
        success: function (response) {
            console.log(response);
            $(".pageloader").hide();
            ...
            if (response != null) {
                ...
                var result = response.map(function (item) {
                    ...
                    result.push(item.amount);
                    result.push(
                        '<a href="edidfeeconfig.php?id=' +
                            item.id +
                            '"><i class="fa fa-edit fafa"></i></a><a href="adminactions.php?action=delete&page=feeconfig&id=' +
                            item.id +
                            '" onclick="return confirmDelete(' +
                            msg +
                            ')"><i class="fa fa-trash-o fafa"></i></a>'
                    );
                    i++;
                    result.push("");
                    return result;
...
$(document).on("click", "#fltnonfeeconfiguration", function () { 
    /*e.preventDefault();
    var classselect = $(this).find(".classselect option:selected").val();
    var streamselect = $(this).find(".streamselect option:selected").val();*/
    var classselect = $("#classselect").val();
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filternonfeeconfiguration", classselect: classselect, streamselect: streamselect },
        success: function (response) {
            $(".pageloader").hide();
            console.log(response);
            var myTable = $(".dataFeeConfiguration").DataTable();
...
$(document).on("click", "#fltnonfeepaidchallan", function () {   
    /*var classselect = $("#classselect").find(".classselect option:selected").val();
    var streamselect = $("#streamselect").find(".streamselect option:selected").val();
    var sectionselect = $("#sectionselect").find(".sectionselect option:selected").val();*/
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    var sectionselect = $("#sectionselect").val();
    $(".pageloader").show();
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filternonfeepaidchallan", classselect: classselect, streamselect: streamselect, sectionselect: sectionselect, common: $("#commonfee").val() },
        success: function (response) {
            $(".pageloader").hide();
            console.log(response);
...
$("#filterstudentdetails").submit(function (e) {
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filterstudent", classselect: classselect, streamselect: streamselect, sectionselect: sectionselect },
        success: function (response) {
            console.log(response);
            $(".pageloader").hide();
            ...
            if (response != null) {
                ...
                var result = response.map(function (item) {
                    ...
                    if (item.status == "ACTIVE") {
                        result.push(
                            '<a href="adminactions.php?status=ACTIVE&id=' +
                                item.id +
                                '&page=s"><i class="fa fa-check fafaactive fafa"></i></a><a href="editstd.php?id=' +
                                item.id +
                                '"><i class="fa fa-edit fafa"></i></a><a href="adminactions.php?action=delete&id=' +
                                item.id +
                                '&page=s" onclick="return confirmDelete(' +
                                Student +
                                ')"><i class="fa fa-trash-o fafa"></i></a>'
                        );
                    } else {
                        result.push(
                            '<a href="adminactions.php?status=INACTIVE&id=' +
                                item.id +
                                ' &page=s"><i class="fa fa-close fafainactive fafa"></i></a></a><a href="editstd.php?id=' +
                                item.id +
                                '"><i class="fa fa-edit fafa"></i></a><a href="adminactions.php?action=delete&id=' +
                                item.id +
                                '&page=s" onclick="return confirmDelete(' +
...
$(document).on("click", "#fltchallan", function () {
    localStorage.setItem("filter", 1);
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    var sectionselect = $("#sectionselect").val();
    var studtype = $("#studtype").val();
    var studdatatype = $("#studdatatype").val();
    var ttype = $("#transporttype").val();
    $(".pageloader").show();
    $.ajax({
        type: "post",
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filterchallan", classselect: classselect, streamselect: streamselect, sectionselect: sectionselect, studtype: studtype, studdatatype: studdatatype, ttype: ttype },
        success: function (response) {
            console.log(response);
            $(".pageloader").hide();
            ...
            if (response != null) {
                ...
                var result = response.map(function (item) {
                    var result = [];
                    result.push(
                        '<input type="checkbox" name="checkme[]" class="checkme" value="' +
                            item.studentId +
                            '" style="margin:10px;" id="checkme' +
                            i +
                            '"><input type="hidden" name="cid[]"  value="' +
                            item.challanNo +
                            '"><input type="hidden" name="cno" class="cno" value="' +
                            item.challanNo +
                            '">'
                    );
                    result.push(i);
...
/*$("#filterchallan").submit(function (event) {
    event.preventDefault();
    localStorage.setItem("filter", 1);
    var classselect = $(this).find(".classselect option:selected").val();
    var streamselect = $(this).find(".streamselect option:selected").val();
...
$("#filterTeacherdetails").submit(function (e) {
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filterteacher", classselect: classselect, sectionselect: sectionselect, stream: stream },
        success: function (response) {
            $(".pageloader").hide();
...
/*$("#filtercreatedchallans").submit(function () {
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filtercreatedchallan", classselect: classselect, streamselect: streamselect, sectionselect: sectionselect, semesterselect: semesterselect, yearselect: yearselect },
        success: function (response) {
            console.log(response);
            $(".pageloader").hide();
            ...
            if (response != null) {
                ...
                var result = response.map(function (item) {
                    ...
                    if(item.visible==0){
                       var vstatus='&nbsp;<a href="adminactions.php?status=INACTIVE&id='+item.challanNo+'&page=challan"><i class="fa fa-close fafainactive fa-lg"></i></a>';
                    }else{
                       var vstatus='&nbsp;<a href="adminactions.php?status=ACTIVE&id='+item.challanNo+'&page=challan"><i class="fa fa-check fafaactive fa-lg"></i></a>';
                    }
                    result.push(
                        '<a href="editcreatedchallans.php?id=' +
                            item.challanNo +
                            '"><i class="fa fa-edit fafa" style="font-size:10px;"></i></a>&nbsp;<a href="adminactions.php?actions=delete&id=' +
                            item.challanNo +
                            '" onclick="return confirmDelete(' +
                            msg +
                            ')"><i class="fa fa-trash-o fafa"></i></a>&nbsp;<a href="#viewModal" data-id="' +
                            item.studentId +
                            '" data-feegroup="' +
                            item.feeGroup +
                            '" class="viewmodal" id="' +
                            item.challanNo +
                            '" data-toggle="modal" data-target="#viewModal"><i class="fa fa-eye fa-lg"></i></a>&nbsp;'+vstatus
                    );
                    i++;
                    result.push("");
                    return result;
...
$(document).on("click", "#fltcreatedchallan", function () {
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    var sectionselect = $("#sectionselect").val();
    var semesterselect = $("#semesterselect").val();
    var yearselect = $("#yearselect").val();
    var admrole = $("#admrole").val();
    var challanstatus = $("#challanstatus").val();
    $(".pageloader").show();
    $.ajax({
        type: 'post',
        ...
        success: function(response) {
            ...
            if (response != null) {
                ...
                var result = response.map(function(item) {
                    var result = [];
                    result.push('<input type="checkbox" name="checkme[]" class="checkme" id="checkme" value="'+item.challanNo+'" style="margin:10px;">');
                    result.push(i);
                    result.push(item.studentId);
                    result.push(item.challanNo);
                    result.push(item.studentName);
...
/*var action1="filter";
var admrole="";
$("#filtercreatedchallans").submit(function (event) {
    action1=$("#button_action").val();
    admrole=$("#admrole").val();
    if(action1=='filter'){
        event.preventDefault();
...
$(document).on("click", "#fltnonfeecreatedchallan", function () { 
    //event.preventDefault();
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    var sectionselect = $("#sectionselect").val();
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filternonfeecreatedchallan", classselect: classselect, streamselect: streamselect, sectionselect: sectionselect },
        success: function (response) {
            $(".pageloader").hide();
            var myTable = $(".dataTableNonfee").DataTable();
            if (response != null) {
                ...
                var result = response.map(function (item) {
                    ...
                    result.push(item.total);
                    result.push(
                        '<a href="editnonfeecreatedchallans.php?id=' +
                            item.cid +
                            '"><i class="fa fa-edit fafa" style="font-size:10px;"></i></a><a href="adminactions.php?actions=delete&id=' +
                            item.cid +
                            '"><i class="fa fa-trash-o fafa"></i></a>'
...
$(document).on("click", "#fltpaidchallan", function () {
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    var sectionselect = $("#sectionselect").val();
    var semesterselect = $("#semesterselect").val();
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filterpaidchallan", classselect: classselect, streamselect: streamselect, sectionselect: sectionselect, semesterselect: semesterselect, yearselect: yearselect },
        success: function (response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $(".dataTableTeachers").DataTable();
...
/*$("#filterpaidchallans").on('submit', function(event){
    event.preventDefault();
    var classselect = $(this).find(".classselect option:selected").val();
    var streamselect = $(this).find(".streamselect option:selected").val();
    var sectionselect = $(this).find(".sectionselect option:selected").val();
...
$(document).on("click", "#fltledgerreport", function () {
    //event.preventDefault();
    ...
    var yearselect = $("#yearselect").val();
    var semesterselect = $("#semesterselect").val();
    var feegroupselect = $("#feegroupselect").val();
    var feetypeselect = $("#feetypeselect").val();
    var streamselect = $("#streamselect").val();
    var classselect = $("#classselect").val();
    var sectionselect = $("#sectionselect").val();
...
$(document).on("click", "#fltstudentledger", function () {
    $(".studentidthereornot").html("");
    var studentid = $("#studentidreport").val();
    var yearselect = $("#yearselect").val();
    $(".pageloader").show();
    $.ajax({
        type: "post",
...
/*$("#filterstudentledger").on('submit', function(event){    
    $(".studentidthereornot").html("");
    event.preventDefault();
    var studentid = $(this).find(".studentidreport").val();
    var yearselect = $(this).find(".yearselect").val();
    $(".pageloader").show();
    $.ajax({
        type: "post",
        url: "adminactions.php",
...
$("#paid_details").on('submit', function(event){    
    event.preventDefault();
    var classselect = $(this).find(".classselect option:selected").val();
    var streamselect = $(this).find(".streamselect option:selected").val();
    var sectionselect = $(this).find(".sectionselect option:selected").val();
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filterpayment", classselect: classselect, streamselect: streamselect, sectionselect: sectionselect },
        success: function (response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $(".paidreport").DataTable();
...
$(".challandetails").hide();
$(".chequeDetails").hide();
$("#getchallan").on('submit', function(event){
    event.preventDefault();
...
$(document).on("click", ".feegroupcheck", function () {
    ...
    $.ajax({
        ...
        method: "post",
        dataType: "json",
        data: { getfeegroupamount: "new", cno: cnum, feegroup: feegroup },
        success: function (response) {
            console.log(response);
            $("#amount").val(response);
        },
...
$(document).on("click", ".viewChallanModal", function () {
    ...
    $.ajax({
        ...
        method: "post",
        dataType: "json",
        data: { submit: "viewChallanUpdatedData", studId: studId, challanNo: challanNo, feetype: selectedFeeType },
        success: function (response) {
            $(".pageloader").hide();
            console.log(response);
            ...
            if (response == "already exist") {
                ...
                var html =
                    ...
                    selectedFeeType +
                    '" /><input type="hidden" name="challanNo" id="challanNo" value="' +
                    response.challanNo +
                    '"><input type="hidden" name="stream"  value="' +
                    response.stream +
                    '"/><input type="hidden" name="sfsextrautilities" id="sfsutilitiesinput" /><input type="hidden" name="schoolextrautilities" id="schoolutilitiesinput" /><input type="hidden" name="sfsextrautilitiesamount" id="sfsutilitiesinputamount"/><input type="hidden" name="schoolextrautilitiesamount" id="schoolutilitiesinputamount"/><input type="hidden" name="sfsextrautilitiesqty" id="sfsutilitiesinputqty"/><input type="hidden" name="schoolextrautilitiesqty" id="schoolutilitiesinputqty"/><table class="table table-striped"><tr><td colspan="2"><label> School Name: </label> LMOIS - ' +
...
$("#getStudentData").on('submit', function(event){
    event.preventDefault();
    ...
    $.ajax({
        ...
        method: "post",
        dataType: "json",
        data: { submit: "getStudData", chlno: chlno },
        success: function (response) {
            $(".errormessage").html("");
            if (response != null) {
                var html =
                    '<table class="table borderless"><tr><td><label>Name: </label> ' +
                    response.studentName +
                    "</td><td><label>Semester: </label> " +
                    response.term +
                    "</td></tr><tr><td><label>ID: </label> " +
                    ...
                    "-" +
                    response.section +
                    '</td></tr><tr></tr><tr><td colspan="2"><form method="post" class="form-horizontal" action="adminactions.php" ><input type="hidden" name="studId" value="' +
                    response.studentId +
                    '"><input type="hidden" name="chlno" value="' +
                    chlno +
                    '"><div class="form-group"><label class="control-label col-sm-3" for="pwd">FeeTypes: </label><div class="col-sm-9"><select name="feetype" id="sfeetype" class="form-control"><option value="">--Select--</option>';
                $.each(response.feeData, function (i, val) {
                    html += "<option value=" + val.id + ">" + $.trim(val.feeType) + "</option>";
                });
                html +=
                    '</select></div></div><div class="form-group"><div class="text-center"><a href="#viewChallanModal" data-challan="' +
                    chlno +
                    '" class="btn btn-primary viewChallanModal" id="' +
                    response.studentId +
                    '" data-toggle="modal" data-target="#viewChallanModal">Create</a></div></div></form></td><tr>';
...
$(document).on("click", "#flttopupchallans", function () { 
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    var sectionselect = $("#sectionselect").val();
    $(".pageloader").show();
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filtertopupchallan", classselect: classselect, streamselect: streamselect, sectionselect: sectionselect },
        success: function (response) {
            $(".pageloader").hide();
...
$("#filterdemandreport").on('submit', function(event){
    event.preventDefault();
    var streamselect = $(this).find(".streamselect option:selected").val();
    var yearselect = $(this).find(".yearselect option:selected").val();
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filterdemandreport", yearselect: yearselect, streamselect: streamselect, feetypeselect: feetypeselect, feegroupselect: feegroupselect, paidselect: paiddetailsselect },
        success: function (response) {
            $(".pageloader").hide();
            var myTable = $(".dataTableDemandReport").DataTable();
            if (response != null) {
                ...
                var result = response.map(function (item) {
                    ...
                    result.push(i);
                    result.push(
                        '<a href="#demandreportviewmodal" data-id="' + item.studentId + '"  class="demandreportview" id="' + item.challanNo + '" data-toggle="modal" data-target="#demandreportviewmodal"><i class="fa fa-2x fa-eye"></i></a>'
                    );
                    result.push(item.academicYear);
                    result.push(item.studentId);
                    result.push(item.studentName);
...
$("#filterreceiptreport").submit(function (e) {
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filterreceiptreport", streamselect: streamselect, yearselect: yearselect, semesterselect: semesterselect },
        success: function (response) {
            console.log(response);
            $(".pageloader").hide();
...
$("#filterreceiptreportview").submit(function (e) {
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filter: "filterreceiptreportview", studentid: studentid, yearselect: yearselect, semesterselect: semesterselect },
        success: function (response) {
            console.log(response);
            if (response != null) {
                $(".pageloader").hide();
...
$(document).on('click', '#class-wiseFlt', function() {
    var year = $('#dash_yearselect').val();
    var stream = $("#dash_streamselect").val();
    var stustatus = $("#dash_studstatus").val();
    var term = $("#semesterselect").val();
    var from = $("#from").val();
    var to = $("#to").val();
    $(".pageloader").show();
    $.ajax({
        ...
        success: function(response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $('.dataTableDashboard').DataTable({
                "paging": false,
                "autoWidth": true,
                "bDestroy": true,
                "dom": 'Bfrtip',
                "ordering": false,
                buttons: [ { extend:'excelHtml5', title:'Dashboard - Class-wise Data', filename:'Dashboard - Class-wise Data', text: 'Export Excel',"className": 'btn btn-info', footer: true} ],
            ...
            if (response != null) {
                ...
                var result = response.map(function(item) {
                    ...
                    result.push(item.stream);
                    result.push(item.class);
                    result.push(item.stud_count);
                    result.push(item.sum_of_sfs_demand);
                    result.push(item.sum_of_lmois_demand);
                    result.push(item.sum_of_lmes_demand);
                    result.push(item.count_of_paid_stud);
                    result.push(item.sum_of_sfs_receipt);
                    result.push(item.sum_of_lmois_receipt);
                    result.push(item.sum_of_lmes_receipt);
                    result.push(item.sum_of_waivers);
                    i++;
                    result.push("");
                    return result
                });
...
$(document).on('click', '#summary-wiseFlt', function() {
    var year = $('#summary_yearselect').val();
    var stream = $("#summary_streamselect").val();
    var term = $("#summary_semesterselect").val();
    var from = $("#summary_from").val();
    var to = $("#summary_to").val();
    $(".pageloader").show();
    $.ajax({
        type: 'post',
        url: 'adminactions.php',
        ...
        success: function(response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $('.dataTableSummary').DataTable({
                "paging": false,
                "autoWidth": true,
                "bDestroy": true,
                "dom": 'Bfrtip',
                "ordering": false,
                buttons: [ { extend:'excelHtml5', title:'Dashboard - Summary Data', filename:'Dashboard - Summary Data', text: 'Export Excel',"className": 'btn btn-info'} ],
            ...
            if (response != null) {
                ...
                var result = response.map(function(item) {
                    var result = [];
                    //result.push(i);
                    result.push(item.lbl_title);
                    result.push(item.exists);
                    result.push(item.new);
...
$(document).on('click', '#dtwise_wiseFlt', function() {
    var year = $('#dtwise_yearselect').val();
    var stream = $("#dtwise_streamselect").val();
    var term = $("#dtwise_semesterselect").val();
    var from = $("#dtwise_from").val();
    var to = $("#dtwise_to").val();
    $(".pageloader").show();
    $.ajax({
        type: 'post',
        url: 'adminactions.php',
        ...
        success: function(response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $('.dataTableDatewise').DataTable({
                "paging": false,
                "autoWidth": true,
                "bDestroy": true,
                "dom": 'Bfrtip',
                "ordering": false,
                buttons: [ { extend:'excelHtml5', title:'Dashboard - Date-wise Data', filename:'Dashboard - Date-wise Data', text: 'Export Excel',"className": 'btn btn-info', footer: true} ],
                columnDefs: [{ targets: [1, 2, 3], className: "text-right" }],
                "footerCallback": function ( row, data, start, end, display ) {
                    var api = this.api();
                    nb_cols = api.columns().nodes().length;
                    $( api.column( 0 ).footer() ).html('');
                    $( api.column( 1 ).footer() ).html('');
                    $( api.column( 2 ).footer() ).html('Grand Total');
                    var j = 3;
                    while(j < nb_cols){
                        var pageTotal = api
                    .column( j, { page: 'current'} )
...
$(document).on('click', '#fltpaidreport', function() {
    var streamselect = $("#streamselect").val();
    var yearselect = $("#yearselect").val();
    var classselect = $("#classselect").val();
    //var sectionselect = $("#sectionselect").val();
    ...
    $.ajax({
        ...
        success: function(response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $('.dataTablePaidReport').DataTable();
            if (response != null) {
                myTable.clear();
                var i = 1;
                var result = response.map(function(item) {
                    ...
                    result.push(item.term);
                    result.push(item.academic_yr);
                    result.push(item.paidamt);
                    result.push(item.transDate);
                    result.push(item.challanNo);
                    result.push(item.paymentmethod);
                ...
                myTable.rows.add(result);
                myTable.draw();
                $(".paidexportexcel").attr("disabled", !1);
                //$("#paidexportexcel").show();
            } else {
                $(".paidexportexcel").attr("disabled", !0);
                //$("#paidexportexcel").hide();
                myTable.context[0].oLanguage.sEmptyTable = "No matching records found...";
                myTable.clear().draw();
...
$(document).on('click', '#fltadvancereport', function() {
    var streamselect = $("#streamselect").val();
    var yearselect = $("#yearselect").val();
    var classselect = $("#classselect").val();
    var sectionselect = $("#sectionselect").val();
    ...
    $.ajax({
        ...
        success: function(response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $('.dataTableAdvanceReport').DataTable();
            if (response != 0) {
                myTable.clear();
                var i = 1;
                var result = response.map(function(item) {
                    ...
                    result.push(item.academic_yr);
                    result.push(item.amount);
                    if(item.transStatus=='Ok'){
                        result.push("<p style='color:green'>Success</p>");
                    }else{
                      result.push("<p style='color:red'>Failed</p>");
                    }
                ...
                myTable.rows.add(result);
                myTable.draw();
                $(".advanceexportexcel").attr("disabled", !1);
            } else {
                $(".advanceexportexcel").attr("disabled", !0);
                myTable.context[0].oLanguage.sEmptyTable = "No matching records found...";
                myTable.clear().draw();
...
$(document).on('click', '#fltadvBalRpt', function() {
    var streamselect = $("#streamselect").val();
    var yearselect = $("#yearselect").val();
    var classselect = $("#classselect").val();
    var sectionselect = $("#sectionselect").val();
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response != 0) {
                ...
                myTable.rows.add(result);
                myTable.draw();
                $(".advbalexportexcel").attr("disabled", !1);
            } else {
                $(".advbalexportexcel").attr("disabled", !0);
                myTable.context[0].oLanguage.sEmptyTable = "No matching records found...";
                myTable.clear().draw();
...
$(document).on('click', '#fltconsolidatereport', function() {
    var streamselect = $("#streamselect").val();
    var yearselect = $("#yearselect").val();
    var classselect = $("#classselect").val();
    //var sectionselect = $("#sectionselect").val();
    ...
    $.ajax({
        ...
        success: function(response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $('.dataTableConsolidatedReport').DataTable();
            if (response != null) {
                myTable.clear();
                var i = 1;
                var result = response.map(function(item) {
                    ...
                    result.push(item.term);
                    result.push(item.academic_yr);
                    result.push(item.demand);
                    /*if(item.transStatus=='Ok'){
                        result.push("<p style='color:green'>Success</p>");
                    }else{
                      result.push("<p style='color:red'>Failed</p>");
                    }*/
                    result.push(item.waiver);
                    result.push(item.receipt);
                    //result.push(item.advancepaid);
                    result.push(item.outstanding);  
                    //result.push(item.challanNo);
                    //result.push(item.transDate);
                    //result.push('');
                    i++;
                ...
                myTable.rows.add(result);
                myTable.draw();
                $(".consolidatedexportexcel").attr("disabled", !1);
                //$("#paidexportexcel").show();
            } else {
                $(".consolidatedexportexcel").attr("disabled", !0);
                //$("#paidexportexcel").hide();
...
$(".tax_exemption_form").on("submit", function () {
    ...
    $.ajax({
        ...
        dataType: "json",
        method: "post",
        data: { preview_tax_exemption: "preview_tax_exemption", student_id: student_id, academic_year: academic_year, amount: amount },
        success: function (response) {
            if (response != "") {
...
$(document).on("click", ".download_tax_exemption", function () {
    ...
    $.ajax({
        ...
        dataType: "json",
        method: "post",
        data: { generate_tax_exemption: "generate_certificate", student_id: student_id, academic_year: academic_year, amount: amount, flag_value: flag_value, row_id: row_id },
        success: function (response) {
            $(".pageloader").hide();
            console.log(response);
            location.reload();
...
$(document).on("click", ".edit_amt", function () {
    ...
    $.ajax({
        ...
        dataType: "json",
        method: "post",
        data: { edit_amount_tax_exemption: "edit_amount_tax_exemption", id: id },
        success: function (response) {
            console.log(response);
            if (response != null) {
                $.each(response, function (i, row) {
...
$(document).on("click", ".delete_entry", function () {
    ...
    $.ajax({
        ...
        dataType: "json",
        method: "post",
        data: { delete_entry: "delete_entry", id: id },
        success: function (response) {
            console.log(response);
            location.reload();
        },
...
$("#tax_exemption_filter").submit(function (e) {
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { filtertaxexemption: "filtertaxexemption", streamselect: streamselect, classselect: classselect, sectionselect: sectionselect },
        success: function (response) {
            console.log(response);
            $(".pageloader").hide();
            ...
            if (response != 0) {
                ...
                var result = response.map(function (item) {
                    ...
                    result.push(
                        '<a class="edit_amt" id="' +
                            item.id +
                            '"><i class="fa fa-edit"></i></a> <a href="' +
                            item.pdf_url +
                            '" target = "_blank"><i class="fa fa-eye"></i></a> <a onclick="print(\'' +
                            item.pdf_url +
                            '\')"><i class="fa fa-print"></i></a> <a class="delete_entry" id="' +
                            item.id +
...
$(".btn-toggle").click(function () {
    ...
    if ($(this).find(".btn-primary").length > 0) {
        ...
        $.ajax({
            ...
            url: "adminactions.php",
            dataType: "json",
            data: { filter: "nonfeetoggle", selected: selected },
            success: function (response) {
                console.log(response);
                $(".pageloader").hide();
                var myTable = $(".dataTableNonfeePaid").DataTable();
...
$("#ledgerstudentid").keyup(function (e) {
    ...
    x_timer = setTimeout(function () {
        $.ajax({
            ...
            url: "adminactions.php",
            dataType: "json",
            data: { findchallanforstdid: "findchallanforstdid", stdid: stdid },
            success: function (response) {
                $(".challanthereornot").html("");
                if (response != 0) {
...
$(".challanselect").change(function () {
    ...
    $.ajax({
        ...
        url: "adminactions.php",
        dataType: "json",
        data: { getstudentledger: "getstudentledger", challannumber: challannumber },
        success: function (response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $(".dataTableNonfeePaid").DataTable();
...
$(document).on("click", "#showfeechallan", function() {
        var data = $("#feechallanform").serialize();
        var studId = $("#studentId").val();
        var stream = $("#stream").val();
        var name = $("#studentName").val();
        var sem = $(".term").val();
            ...
            success: function(response) {
                ...
                if (response == "Fee Types empty") {
                    ...
                    if (response.is_exists > 0) {
                        //html += 'Challan for the same details already exists.futher details please contact admin.';
                        html += '<table class="table table-striped"><tr><td><label>Challan Already Exists: </label></td></tr>';
                        $.each(response.exists, function(i, row) {
                            html += '<tr><td><p class="error-msg">' + row + '</p></td></tr>';
                        });
                        html += '</table>';
                        $("#createchallan").hide();
                    } 

                    if(response.challanData!='')
                    {
                        var d = new Date(duedate);
                        duedate = d.getDate() + '-' + (d.getMonth() + 1) + '-' + d.getFullYear();
                        html += '<form id="studDataModal"></form><input type="hidden" name="challanId" id="challanId" value="' + response.challanData.id + '" ><input type="hidden" name="class" value="' + clasid + '" /><table class="table table-striped"><tr><td colspan="2"><label> School Name: </label> LMOIS - ' + response.challanData.streamname + '</td></tr><tr><td><label>Name: </label> ' + name + '</td><td class="text-right"><label>Semester: </label> ' + semester + '</td></tr><tr><td><label>ID: </label> ' + studId + '</td><td class="text-right"><label>Class: </label> ' + classtxt + '</td></tr><tr><td colspan="2">';
                        html += '<table class="table table-striped"><tr><td><label>Challan Number: </label> ' + response.challanData.challanNo + '</td><td class="text-right"><label>Due Date: </label> ' + duedate + '</td></tr>';
                        var amount = 0;
                        $.each(response.feeData, function(i, row) {
                            html += '<tr><td><label>' + i + '</label></td><td></td></tr>';
                            $.each(row, function(index, el) {
                                $.each(el, function(am, val) {
                                    if ($.trim(val[0]) != 0) {
                                        html += '<tr><td>' + val[1] + '</td><td class="text-right">' + val[0] + '</td></tr>';
                                    }
                                    amount += parseInt(val[0]);
                                })
                            })
                        });
                        html += '<tr></tr><tr><td><strong>Total</strong></td><td class="text-right"> ' + amount + '</td></tr></table>';
                        html += '</td></tr></table>'
...
$(document).on('click', '#filterstudentpartial', function() {
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    var sectionselect = $("#sectionselect").val();
    var academic = $("#yearselect").val();
    var st_status = $('#st_status').val();
    $(".pageloader").show();
    $.ajax({
        type: 'post',
        ...
        success: function(response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $('.dataTablePartial').DataTable();
            if (response != null) {
                var Student = "'Student.'";
                myTable.clear();
                var i = 1;
                ...
                var result = response.map(function(item) {
                    var result = [];
                    result.push('<input type="checkbox" name="checkme[]" class="checkme" value="' + item.id + '" style="margin:10px;" id="checkme' + i + '">');
                    result.push(i);
                    result.push(item.studentId);
                    result.push(item.studentName);
                    result.push(item.class_list);
                    result.push(item.stream);
                    result.push(item.academic_yr);
                    result.push(item.partial_min_percentage);
                    result.push(item.status);
                    
                    if (item.status == "ACTIVE") {
                        stst='<a href="adminactions.php?status=ACTIVE&id=' + item.id + '&page=partial"><i class="fa fa-check fafaactive fafa"></i></a>';
                    } else {
                        stst='<a href="adminactions.php?status=INACTIVE&id=' + item.id + ' &page=partial"><i class="fa fa-close fafainactive fafa"></i></a>';
                    }
                    stst+='&nbsp;<a href="editpartial.php?id=' + item.id + '"><i class="fa fa-edit fafa"></i></a>&nbsp;<a href="adminactions.php?action=delete&id=' + item.id + '&page=partial" onclick="return confirmDelete(' +msgdl+ ')"><i class="fa fa-trash-o fafa"></i></a>';
                    result.push(stst);
...
/* Cheque DD Fee Type Start */
$(document).on('click', '#closepay_ftype', function() {
    //$(".chequeDetails").hide();
    $(".challandetailsNew").hide();
});
$(document).on('click', '.feegroupcheckNew', function() {
    var feegroup = $(this).val();
    var groupdiv="#"+feegroup;
       if($(this).is(":checked")){
          $("#ptype_"+feegroup).attr('required', !0);
          $("#paiddate_"+feegroup).attr('required', !0);
          $(groupdiv).show();
       }else{
          $("#ptype_"+feegroup).attr('required', !1);
          $("#paiddate_"+feegroup).attr('required', !1);
          $(groupdiv).hide();
       }   
});
function tohandlechange(id,gid){
    var val = id.value;
    if (val == 'Online') {
        $('.onlinebank_'+gid).show();
        $('.onlinetrans_'+gid).show();
        $('.chequebank_'+gid).hide();
        $('.chequeno_'+gid).hide();
        $("#bank_"+gid).attr('required', !0);
        $("#paymentmodetrans_"+gid).attr('required', !0);
        $("#cbank_"+gid).attr('required', !1);
        $("#paymentmode_"+gid).attr('required', !1);
    }else{
       $('.onlinebank_'+gid).hide();
        $('.onlinetrans_'+gid).hide();
        $('.chequebank_'+gid).show();
        $('.chequeno_'+gid).show();
        $("#bank_"+gid).attr('required', !1);
        $("#paymentmodetrans_"+gid).attr('required', !1);
        $("#cbank_"+gid).attr('required', !0);
        $("#paymentmode_"+gid).attr('required', !0);
    }
}
/* Cheque DD Fee Type End */
$(document).on("click", "#fltstud", function () {
    var classselect = $('#classselect').val();
    var streamselect = $('#streamselect').val();
    var sectionselect = $('#sectionselect').val();
    var st_status = $('#st_status').val();
        ...
        success: function(response) {
            ...
            if (response != null) {
                ...
                var result = response.map(function(item) {
                    ...
                    result.push(item.section);
                    result.push(item.term);
                    result.push(item.parentprimaryemail);
                    result.push(item.status);
                    if (item.status == "ACTIVE") {
...
$(document).on('click', '.paidexportexcel', function(event) {
    if (!$('.paidexportexcel').is('[disabled=disabled]')) {
        $(".paidexportexcel").attr("href", "adminactions.php?paidreport=exportexcel")
    } else {
        event.preventDefault();
        $(".paidexportexcel").attr("href", "");
    }
});
$(document).on('click', '.consolidatedexportexcel', function(event) {
    if (!$('.consolidatedexportexcel').is('[disabled=disabled]')) {
        $(".consolidatedexportexcel").attr("href", "adminactions.php?consolidated=exportexcel")
    } else {
        event.preventDefault();
        $(".consolidatedexportexcel").attr("href", "");
    }
});

$(document).on('click', '.advanceexportexcel', function(event) {
    if (!$('.advanceexportexcel').is('[disabled=disabled]')) {
        $(".advanceexportexcel").attr("href", "adminactions.php?advancereport=exportexcel")
    } else {
        event.preventDefault();
        $(".advanceexportexcel").attr("href", "");
    }
});

$(document).on('click', '.advbalexportexcel', function(event) {
    if (!$('.advbalexportexcel').is('[disabled=disabled]')) {
        $(".advbalexportexcel").attr("href", "adminactions.php?advbalexportexcel=exportexcel")
    } else {
        event.preventDefault();
        $(".advbalexportexcel").attr("href", "");
    }
});

$(document).on('click', '.otherexportexcel', function(event) {
    if (!$('.otherexportexcel').is('[disabled=disabled]')) {
        $(".otherexportexcel").attr("href", "adminactions.php?otherfeeexport=exportexcel")
    } else {
        event.preventDefault();
        $(".otherexportexcel").attr("href", "");
    }
});

$(document).on('click', '.partialexportexcel', function(event) {
    if (!$('.partialexportexcel').is('[disabled=disabled]')) {
        $(".partialexportexcel").attr("href", "adminactions.php?partialreport=exportexcel")
    } else {
        event.preventDefault();
        $(".partialexportexcel").attr("href", "");
    }
});

//*************OTHER FEES (LUNCH, UNIFORM) FILTER- Start************//
//$("#otherfeefilters").submit(function() {
$(document).on('click', '#otherfeeflt', function() {
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    //var sectionselect = $("#sectionselect").val();
    var yearselect = $("#yearselect").val();
        ...
        success: function(response) {
            ...
            if (response != null) {
                ...
                var result = response.map(function(item) {
                    ...
                    result.push(item.section);
                    result.push(item.academic_yr);
                    result.push(item.feetypename);
                    result.push(item.transDate);
                    result.push(item.transNum);
                    result.push(item.amount);
                    result.push(item.transStatus);
                    if(item.pdf!='nil'){
                       pdflink='<a href="' + item.pdf + '" target="_blank" id="' + item.id + '"><i class="fa fa-eye fa-lg"></i></a>&nbsp;';
                    }
                    if(item.transStatus!='Ok'){
                       editlink='<a href="editotherfee.php?id=' + item.id + '"><i class="fa fa-edit fafa"></i></a>';
                    }
                    result.push(pdflink+' '+editlink);
                    i++;
                    result.push("");
                    return result
                });
                myTable.rows.add(result);
                myTable.draw();
                $(".otherexportexcel").attr("disabled", !1);
            } else {
                $(".otherexportexcel").attr("disabled", !0);
                myTable.context[0].oLanguage.sEmptyTable = "No matching records found...";
                myTable.clear().draw();
...
//*************OTHER FEES (LUNCH, UNIFORM) FILTER- Start************//
$("#filterfeepayments").submit(function() {
    event.preventDefault();
    var classselect = $(this).find(".classselect option:selected").val();
    var streamselect = $(this).find(".streamselect option:selected").val();
    var sectionselect = $(this).find(".sectionselect option:selected").val();
        ...
        success: function(response) {
            ...
            if (response != null) {
                ...
                var result = response.map(function(item) {
                    ...
                    result.push('<a href="editotherfee.php?cid=' + item.event + '"><i class="fa fa-edit fafa"></i></a>');
                    i++;
                    result.push("");
                    return result;
                });
...
$(document).on("change", "#ptypechk", function() {
    var val = $(this).val();
    if (val == 'Online') {
        $('.Online').show();
        $("#cbank").attr('required', !1);
        $('.Offline').hide();
        $("#bank").attr('required', !0);
        $('#transLbl').html("Transaction Number");
        $('#paymentmodetrans').attr('placeholder',"Transaction Number");
        ...
        $("#bank").attr('required', !1);
        $("#cbank").attr('required', !0);
        $('#transLbl').html("Cheque/DD Number");
        $('#paymentmodetrans').attr('placeholder',"Cheque/DD Number");
    }
});
$(document).on("click","input[name='payop']", function() {
    ...
    var empty='';
    if(inval=='minimum'){
        $("#partialamt").val(minamt);
        $("#partialamt").attr("readonly",true);
        //$("#paytotal").val('partial');
    }
    else if(inval=='partialfull'){
        $("#partialamt").val(g_tot);
        $("#partialamt").attr("readonly",true);
        //$("#paytotal").val('full');
    }else if(inval=='full'){
        $("#partialamt").val(g_tot);
        $("#partialamt").attr("readonly",true);
        //$("#paytotal").val('full');
    }else if(inval=='caution'){
        $("#partialamt").val($('#c_tot').val());
        $("#partialamt").attr("readonly",true);
        //$("#paytotal").val('full');
    }else{
       $("#partialamt").val(empty);
       $("#partialamt").attr("readonly",false);
       //$("#paytotal").val('partial');
    }

});    

$(document).on("click","#paytotal_adm", function() {
    var  grand_tot=$("#g_tot").val();
    var  minper=$("#minper").val();
    var  minamt=$("#minamt").val();
    var  paramt=$("#partialamt").val();
    var sub=$("#paytotal_adm").val();
    var disppart=$("#disppart").val();

    if(sub=='partial'){
        paramt=parseInt(paramt);
        minamt=parseInt(minamt);
        grand_tot=parseInt(grand_tot);
        if(paramt < minamt){
            if(disppart!=0){
                alert("Amount should be greater than or equal to minimum amount "+minamt);
                return false;
            }
        }else{
            if(paramt > grand_tot){
                alert("Amount should not exceed the grand total");
                return false;
            }else{
                $("#paytotal_adm").val('partial');
                return true;
            }
        }
    }    
...
$(document).on('click', '#fltpartialreport', function() {
    var streamselect = $("#streamselect").val();
    var yearselect = $("#yearselect").val();
    var classselect = $("#classselect").val();
    //var sectionselect = $("#sectionselect").val();
    ...
    $.ajax({
        ...
        success: function(response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $('.dataTablePartialReport').DataTable();
            if (response != null) {
                myTable.clear();
                var i = 1;
                var result = response.map(function(item) {
                    ...
                    result.push(item.studentName);
                    result.push(item.stream);
                    result.push(item.challanids);
                    result.push(item.payoption);  
                    result.push(item.receivedamount);
                    /*if(item.transStatus=='Ok'){
                        result.push("<p style='color:green'>Success</p>");
                    }else{
                      result.push("<p style='color:red'>Failed</p>");
                    ...
                    result.push(item.cdate);
                    result.push(item.paymentmethod);
                    result.push('<a class="edit_amt" id="' + item.id + '" href="editpartialpayment.php?logid=' + item.id + '"><i class="fa fa-edit fafa"></i></a>');
                    //result.push(item.challanNo);
                ...
                myTable.rows.add(result);
                myTable.draw();
                $(".partialexportexcel").attr("disabled", !1);
                //$("#paidexportexcel").show();
            } else {
                $(".partialexportexcel").attr("disabled", !0);
                //$("#paidexportexcel").hide();
...
$(document).on("click", "#showtransfeechallan", function() {
    var data = $("#feechallanform").serialize();
    var studId = $("#studentId").val();
    var stream = $("#stream").val();
    var name = $("#studentName").val();
...
$(document).on("click", "#showtransfeechallanFrmPaid", function() {
    var data = $("#feechallanform").serialize();
    var studId = $("#studentId").val();
    var stream = $("#stream").val();
    var name = $("#studentName").val();
...
//*************OTHER FEES (Transport FILTER- Start************//
//$("#otherfeefilters").submit(function() {
$(document).on('click', '#otherTransfeeflt', function() {
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    //var sectionselect = $("#sectionselect").val();
    var yearselect = $("#yearselect").val();
        ...
        success: function(response) {
            ...
            if (response != null) {
                ...
                var result = response.map(function(item) {
                    ...
                    var chkbx="";
                    if(item.transStatus=='Ok'){
                        chkbx='<input type="checkbox" name="checkme[]" class="checkme" id="checkme" value="' + item.studentId + '" style="margin:10px;">';
                    }else{
                        chkbx='';
                    }
                    result.push(chkbx);
                    result.push(item.chlstudentid);
                    result.push(item.studentName);
                    result.push(item.streamname);
                    result.push(item.term);
                    result.push(item.class_list);
                    ...
                    if(item.transStatus!='Ok'){
                       editlink='<a href="edittransportfee.php?id=' + item.id + '"><i class="fa fa-edit fafa"></i></a>';
                    }
                    if(item.pdf!='nil'){
                       pdflink='<a href="' + item.pdf + '" target="_blank" id="' + item.id + '"><i class="fa fa-eye fa-lg"></i></a>&nbsp;';
                    }
                    if (($.trim(item.pay_type) == 'Cheque') && item.transStatus=='Ok') {
                        revokelink='<a href="#myModal" data-toggle="modal" name="' + item.id + '" class="chequerevtrans" id="' + item.challanNo + '" title="Revoke"><i class="fa fa-undo"></i></a>';
                    }
                    
                    result.push(pdflink+' '+editlink+' '+revokelink);
                    i++;
                    result.push("");
                    return result
                });
                myTable.rows.add(result);
                myTable.draw();
                $(".othertransportexportexcel").attr("disabled", !1);
            } else {
                $(".othertransportexportexcel").attr("disabled", !0);
                myTable.context[0].oLanguage.sEmptyTable = "No matching records found...";
                myTable.clear().draw();
            }
        }
...
//*************Cart report FEES (Transport FILTER- Start************//
$(document).on('click', '#cartfeeflt', function() {
    var classselect = $("#classselect").val();
    var streamselect = $("#streamselect").val();
    //var sectionselect = $("#sectionselect").val();
    var yearselect = $("#yearselect").val();
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response != null) {
                ...
                myTable.rows.add(result);
                myTable.draw();
                $(".cartexportexcel").attr("disabled", !1);
            } else {
                $(".cartexportexcel").attr("disabled", !0);
                myTable.context[0].oLanguage.sEmptyTable = "No matching records found...";
                myTable.clear().draw();
            }
        }
  ...
  $(".pageloader").show();
    $.ajax({
        ...
        success: function(response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $('.dataTableUserPartial').DataTable();
            if (response != null) {
                myTable.clear();
                var i = 1;
                var result = response.map(function(item) {
...
//*************CART OTHER FEES (LUNCH, UNIFORM) FILTER- End************//
$(".cartexportexcel").attr("disabled", !0);
$(document).on('click', '.cartexportexcel', function(event) {
    if (!$('.cartexportexcel').is('[disabled=disabled]')) {
        $(".cartexportexcel").attr("href", "adminactions.php?cartexportexcel=exportexcel")
    } else {
        event.preventDefault();
        $(".cartexportexcel").attr("href", "");
    }
});


$(document).on('click', '#nfwcfltpaidreport', function() {
    var streamselect = $("#streamselect").val();
    var yearselect = $("#yearselect").val();
    var classselect = $("#classselect").val();
    //var sectionselect = $("#sectionselect").val();
    ...
    $.ajax({
        ...
        success: function(response) {
            console.log(response);
            $(".pageloader").hide();
            var myTable = $('.dataTableNFWCReport').DataTable();
            if (response != null) {
                myTable.clear();
                var i = 1;
                var result = response.map(function(item) {
                    ...
                    result.push(item.receivedamount);
                    if(item.transStatus!='Ok'){
                        result.push(item.transStatus+' <a href="editnfwcpay.php?ref=' + item.transNum + '" name="wavier" class="feewavier"><i class="fa fa-edit fafa"></i></a>');
                    }else{
                        result.push(item.transStatus);
                    }
                    result.push(item.transDate);
                    if(item.type=='nopartial'){
                        result.push(item.challanNo);  
                    }else{
                        result.push(item.refchallanNo);
                    }
                    i++;
                    result.push("");
                    return result
                ...
                myTable.rows.add(result);
                myTable.draw();
                $(".nfwcpaidexportexcel").attr("disabled", !1);
            } else {
                $(".nfwcpaidexportexcel").attr("disabled", !0);
                myTable.context[0].oLanguage.sEmptyTable = "No matching records found...";
                myTable.clear().draw();
...
$(document).on('click', '.nfwcpaidexportexcel', function(event) {
    if (!$('.nfwcpaidexportexcel').is('[disabled=disabled]')) {
        $(".nfwcpaidexportexcel").attr("href", "adminactions.php?nfwcpaidreport=exportexcel")
    } else {
        event.preventDefault();
        $(".nfwcpaidexportexcel").attr("href", "");
    }
});
$(document).on("click", "input[name='paynfw']", function () {
    var inval=$(this).val();
    var n_due=$("#n_due").val();
    var m_due=$("#m_due").val();
    var empty='';
...
//*************OTHER FEES (LUNCH, UNIFORM) FILTER- End************//
$(".othertransportexportexcel").attr("disabled", !0);
$(document).on('click', '.othertransportexportexcel', function(event) {
    if (!$('.othertransportexportexcel').is('[disabled=disabled]')) {
        $(".othertransportexportexcel").attr("href", "adminactions.php?othertransportexportexcel=exportexcel")
    } else {
        event.preventDefault();
        $(".othertransportexportexcel").attr("href", "");
    }
});
$(document).on('click', '.chequerevtrans', function() {
    $(".stdidforcheque").val($(this).attr('id'));
    $("#logid").val($(this).attr('name'));
});

$(document).on('click', '#chequerevokechecktrans', function() {
    document.getElementById("chequerevoketranssubmit").disabled = !1;
});

function calcAmount(id, amt, amtId)
{
     var qty = id.value;
     var gid="#amount_"+amtId;
     var total=amt;  
     if(qty.length > 0){
      total=qty*amt;
     }
