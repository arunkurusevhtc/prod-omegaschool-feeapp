                ...
                <div class="main">
					<form id="user_registered" method="post" action="adminactions.php">
						...
						<div class="form-group">
								...
								<input type="number" id="ctax" name="ctax" required placeholder="central Tax" class="form-control" value="<?php echo trim($res['centralTax']);?>" step=".01">
						</div>

						<div class="form-group">
								<label for ="stax" class="control-label">State Tax</label>
								<input type="number" id="stax" name="stax" required placeholder="State Tax" class="form-control" value="<?php echo trim($res['stateTax']);?>" step=".01">
						</div>
