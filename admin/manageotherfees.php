<?php
    ...
    $typelist= array(1 => 'Uniform', 2 => 'Lunch', 4 => 'Common');
    $status= array('Ok' => 'Completed', 'F' => 'Failed', 'C' => 'Canceled', 'N' => 'Not Updated');

    //createUFPDF('71053','IG 1680');
?>
...
<div class="col-md-12">
    <div class="col-md-6 p-l-0">
        ...
        <form  id="otherfeefilters" class="form-inline">
            ...
            <div class="form-group">
              <button type="button" id="otherfeeflt" name="filter" value="otherfeefilter" class="btn btn-info">Filter</button>
            </div>
            <div class="form-group">
                <a href="" class="btn btn-info otherexportexcel">Export Excel</a>
            </div>
            </div>
        </form>
