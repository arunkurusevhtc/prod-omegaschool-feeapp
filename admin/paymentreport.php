...
?>
    <div class="container-fluid  paymentReport">
       ...
       <form method="post" action="adminactions.php" class="form-inline">
               <div class="row text-right">
                ...
                <div class="col-md-2">
                  <a class="btn btn-info" href="feegroup_report.php">Get Product Data</a>
                </div>
              </div>
        </form>
        <div class="row">
        ...
        <table class="table table-bordered table-responsive admintab paidreport">
            ...
            <tbody>
                 ...
                 <?php
              $count=1;
              $sql = 'SELECT * FROM getpaiddata WHERE amount IS NOT NULL';
