...
<div class="container">
    ...
    <div class="row">
        <div id="topup-container" class="col-md-offset-3 col-md-5">
            <h4 class="crdtoph">Uniform Fee</h4>
            <form class="form-horizontal" action="sql_actions.php" method="post" id="addcartfrm">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <select class="form-control uniformfeestudid" name="studId" id="studId"  required="readonly">
                            <option>-Select-</option>
                            <?php
                                foreach ($studentIds as $sid) {
                                    if ( stristr( $sid['studentId'], 'APPL' ) ) {
                                    }
                                    else{
                ...
                <div class= "eventdetails">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                         <select name="eventname" id="eventname"  class="eventname form-control" required="required">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                         <select name="sfsextraqty" id="uniformnameid" class="form-control" required="required">
                            <option value="">--SELECT--</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type= "text" readonly value="0" name = "amountofevent" id="amountofevent" class="form-control" required="required">
                        </div>
                    </div>
                </div>
                <div class="text-center">
                    <input type="hidden" name="otherfeestype" id="otherfeestype" value="1">
                    <button type='button' name = "addtocart" value= "add" class='btn btn-info addtocart' id="payuniformfee">Add to Cart</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="container-fluid">
    <div class="table-responsive">
        <button type="button" class="btn button1" data-toggle="collapse" data-target="#list">+Uniform-Fee Paid</button>
        <div id="list" class="collapse">
            <table class="table table-bordered opayment1" cellspacing="0" width="400">
                <?php
                    $paiddata = sqlgetresult('SELECT *  FROM otherfeesreport WHERE "parentId" = \''.$_SESSION['uid'].'\' AND "transStatus" = \'Ok\' AND "stustatus" = \'1\' AND "deleted" = \'0\' AND typeid = \'1\' LIMIT 20',true);
                   $challanData = array();
                   $total =0;
                   $tot = 0;    
                   $challanNo  = '';
                   ...
                   if($count != 0) {
                       foreach ($paiddata as $k => $data) {
                           ...
                           $challanData[$k]['isold'] = trim($data['isold']);                      
                       }
                       $data =  $challanData;    
                   } else {
                       $data = array();
