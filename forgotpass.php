			...
			<div class="content content1">
				...
				<div class="main">
						<?php
							...
							?>
					<form id ="forgot" action="sql_actions.php" method="POST" onsubmit="return submitUserForm();">
	            ...
	            <div>
	            <p class="note3">To facilitate email delivery add <a class="note3" href="mailto:feeapp.support@omegaschools.org" target="_top">feeapp.support@omegaschools.org</a> to your contacts. Contact No: 044-66241110.</p>
	        </div>
