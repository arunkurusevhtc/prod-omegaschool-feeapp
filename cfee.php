...
<div class="container">
    ...
    <div class="row">
        <div id="topup-container" class="col-md-offset-3 col-md-5">
            <h4 class="crdtoph">Common Fee</h4>
            <form class="form-horizontal" action="sql_actions.php" method="post" id="addcartfrm">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <select class="form-control commfeestudid" name="studId" id="studId"  required="readonly">
                ...
                <div class= "eventdetails">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                         <select name="eventname" id="eventnamecf"  class="eventname form-control" required="required">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                         <select name="sfsextraqty" id="commfeenameid" class="form-control" required="required">
                            <option value="">--SELECT--</option>
                         </select>
                        </div>
                    </div>
                ...
                <div class="text-center">
                    <input type="hidden" name="otherfeestype" id="otherfeestype" value="4">
                    <button type='button' name = "addtocart" value= "add" class='btn btn-info addtocart' id="paycommfee">Add to Cart</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="container-fluid">
    <div class="table-responsive">
        <button type="button" class="btn button1" data-toggle="collapse" data-target="#list">+Common-Fee Paid</button>
        <div id="list" class="collapse">
            <table class="table table-bordered opayment1" cellspacing="0" width="400">
                <?php
                    $paiddata = sqlgetresult('SELECT *  FROM otherfeesreport WHERE "parentId" = \''.$_SESSION['uid'].'\' AND "transStatus" = \'Ok\' AND "stustatus" = \'1\' AND "deleted" = \'0\' AND typeid = \'4\' LIMIT 20',true);
                   $challanData = array();
                   $total =0;
                   $tot = 0;    
                   $challanNo  = '';
