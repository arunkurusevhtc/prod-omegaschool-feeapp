				...
				<div class="main">
					...
					<form id="user_registered" method="post" action="adminactions.php">
						...
						<div class="form-group">
								...
								<input type="number" id="ctax" name="ctax" required placeholder="Central Tax" class="form-control">
						</div>

						<div class="form-group">
								<label for ="stax" class="control-label">State Tax</label>
								<input type="number" id="stax" name="stax" required placeholder="State Tax" class="form-control">
						</div>
