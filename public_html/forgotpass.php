			...
			<div class="content content1">
				...
				<div class="main">
						<?php
							...
							?>
					<form id ="forgot" action="sql_actions.php" method="POST">
	            ...
	            <div>
	            <p class="note3">To facilitate email delivery add <a class="note3">notification@omegaschools.org</a> to your contacts.</p>
	        </div>
