...
class TransactionRequest
{
    ...
    /**
     * @return the $customerChallanNo
     */
    public function getCustomerChallanNo()
    {
        return $this->customerChallanNo;
    }

    /**
     * @param string $customerChallanNo
     */
    public function setCustomerChallanNo($customerChallanNo)
    {
